...
class StoreDetailController: BaseController {
...
extension StoreDetailController: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
...
extension StoreDetailController: UITableViewDelegate, UITableViewDataSource {
...
extension StoreDetailController: ImageDisplayInterface {
